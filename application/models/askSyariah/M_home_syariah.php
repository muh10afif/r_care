...
class M_home_syariah extends CI_Model {
	...
	public function get_cari_shs_noa($bank)
	{
		...
		$this->db->join('m_korwil_asuransi as i', 'i.id_korwil_asuransi = ca.id_korwil_asuransi', 'left');
		$this->db->join('m_asuransi as m', 'm.id_asuransi = i.id_asuransi', 'left');
	...
	{
		return $this->db->get_where('m_bank', array('id_bank' => 10));
	}
