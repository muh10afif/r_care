...
class M_ots_syariah extends CI_Model {
	...
	public function get_shs_sudah()
	{
		...
		$this->db->join('m_cabang_asuransi as asu', 'asu.id_cabang_asuransi = d.id_cabang_as', 'left');
	...
	{
		$this->db->select('d.id_debitur,d.nama_debitur,d.bunga, asu.cabang_asuransi, d.no_klaim, cab.cabang_bank, d.subrogasi, sum(r.nominal) as recoveries, ms.status_deb, p.nama_proses');
		$this->db->from('debitur as d');
		$this->db->join('m_cabang_asuransi as asu', 'asu.id_cabang_asuransi = d.id_cabang_as', 'left');
	...
	public function get_verifikator2()
	{
