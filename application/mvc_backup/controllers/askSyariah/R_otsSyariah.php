 ...
 * Katalog
 */
class R_otsSyariah extends CI_controller
{
	public function __construct()
	{
        ...
        $this->load->model(array('askSyariah/M_ots_syariah','askSyariah/M_noa_syariah'));
	}
    ...
    public function index()
    {
        if (isset($_POST['cari'])) {
            ...
            $data = [
                'wilayah'       => $this->M_ots_syariah->get_wilayah_capem(),
                'verifikator'   => $this->M_ots_syariah->get_verifikator(),
                'bank'          => $this->M_noa_syariah->get_bank(),
                'asuransi'      => $this->M_ots_syariah->get_asuransi($id = null),
                'data_r_ots'    => $this->M_ots_syariah->get_cari_data_r_ots($tgl_awal, $tgl_akhir, $wilayah, $ver, $bank, $asuransi),
                'peringkat_ver' => $this->M_ots_syariah->get_peringkat_ver($tgl_awal, $tgl_akhir, $wilayah, $ver, $bank, $asuransi),
                'total_noa'     => $this->M_ots_syariah->get_total_noa($tgl_awal, $tgl_akhir, $wilayah, $ver, $bank, $asuransi),
                'total_ots'     => $this->M_ots_syariah->get_total_ots($tgl_awal, $tgl_akhir, $wilayah, $ver, $bank, $asuransi),
                'judul'         => 'OTS',
                'ots'           => 'aktif',
                'p_tgl_awal'    => $tgl_awal,
            ...
            $this->template->load('template_syariah','askSyariah/ots/v_ots', $data);
            ...
            $as = $this->M_ots_syariah->get_asuransi($asuransi)->row_array();
            ...
            $data = [
                'Judul'         => $all,
                'data_r_ots'    => $this->M_ots_syariah->get_cari_data_unduh_r_ots($tgl_awal, $tgl_akhir, $wilayah, $ver, $bank, $asuransi),
                'tgl_awal'      => $tgl_awal,
                'tgl_akhir'     => $tgl_akhir,
                'wilayah'       => $wilayah,
                'ver'           => $ver,
            ...
            $this->load->view('askSyariah/ots/lihat_print', $data);
            ...
            $data = [
                ...
                'bank'          => $this->M_noa_syariah->get_bank(),
                'asuransi'      => $this->M_ots_syariah->get_asuransi($id = null),
                'data_r_ots'    => $this->M_ots_syariah->get_data_r_ots(),
                'peringkat_ver' => $this->M_ots_syariah->get_peringkat_ver($tgl_awal=null, $tgl_akhir=null, $wilayah=null, $ver=null, $bank=null, $asuransi=null),
    ...
    public function unduh_pdf()
    {
        ...
        if (isset($_POST['pdf'])) {
            $this->load->view('askSyariah/ots/print_pdf', $data);
        } else {
            $this->load->view('askSyariah/ots/print', $data);
        }
