 ...
 * Katalog
 */
class R_recovSyariah extends CI_controller
{
	public function __construct()
	{
		...
		$this->load->model(array('askSyariah/M_noa_syariah','askSyariah/M_recov_syariah','askSyariah/M_ots_syariah'));
	}
    ...
    public function index()
    {
        if (isset($_POST['cari'])) {
            ...
            $data = [
                ...
                'status_non_pot' => $this->M_noa_syariah->get_status_pot('Tidak Potensial', $tgl_awal,$tgl_akhir,$potensial,$bank),
                ...
                'wilayah_ver'    => $this->M_recov_syariah->get_data_wilayah_ver(),
                'p_tgl_awal'     => $tgl_awal,
            ...
            $this->template->load('template_syariah','askSyariah/recov/v_recov', $data);
            ...
            $data = [
                'judul'         => $all,
                'data_r_noa'    => $this->M_recov_syariah->get_cari_print_data_r_recov($tgl_awal,$tgl_akhir,$potensial,$bank),
                'tgl_awal'      => $tgl_awal,
                'tgl_akhir'     => $tgl_akhir,
                'potensial'     => $potensial,
                'bank'          => $bank
            ...
            $this->load->view('askSyariah/recov/lihat_print', $data);
            ...
            if (!empty($kalimat)) {
                ...
                $data = [
                    ...
                    'status_non_pot' => $this->M_noa_syariah->get_status_pot('Tidak Potensial', $tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                    ...
                    'wilayah_ver'    => $this->M_recov_syariah->get_data_wilayah_ver(),
                    'data_ver'       => $this->M_recov_syariah->get_cari_data_wilayah_ver($ver,$capem),
                    'wil'            => $kalimat,
                    'p_tgl_awal'     => '',
                    'p_tgl_akhir'    => '',
                    'p_potensial'    => '',
    ...
    public function unduh_pdf()
    {
        ...
        $this->load->view('askSyariah/recov/print', $data);
    }
}