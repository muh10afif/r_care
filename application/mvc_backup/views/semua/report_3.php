        ...
        <tbody>
          ...
          foreach ($nama_ver_jabar as $v): ?>
            ...
            <tr>
              ...
              <?php $noa_sudah = $this->M_all_report->get_data_jml_noa_sdh(1,$d_bulan_awal,$d_bulan_akhir,$v['id_karyawan']); ?>
          ...
          foreach ($nama_ver_jateng as $v): ?>
            <tr>
              ...
              <?php $noa_sudah = $this->M_all_report->get_data_jml_noa_sdh(3,$d_bulan_awal,$d_bulan_akhir,$v['id_karyawan']); ?>
              <td align="right"><?= $jl_noa ?></td>
              <td align="right"><?= number_format($jl_shs,0,'.','.') ?></td>
