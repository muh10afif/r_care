...
<section class="content">
	<div class="row">
		...
		<form method="POST" target="_self" id="tab" action="<?= base_url('askSyariah/r_otsSyariah') ?>">
	         ...
	         <div class="row">
	      	...
	      	<div class="box-footer">
	      		<div class="col-md-12" align="right">
	      			<button class="btn" onclick="b()" name="cari" style=" background-color: #EDE90F; color: #122E5D; font-weight: bold; font-size: 15px;">Tampilkan</button><?= nbs(3) ?>
		      		<button class="btn" onclick="b()" name="all" style=" background-color: #122E5D; color: white; font-size: 15px;">Tampil Semua</button><?= nbs(3) ?>
	            	<button name="unduh" onclick="a()" class="btn" style=" background-color: #EDE90F; color: #122E5D;  font-weight: bold; font-size: 15px;">Unduh PDF</button>
	           	</div>
                ...
                <div class="box-body">
                    <table class="table table-striped table-hover">
                      ...
                      <?php $no=1; foreach ($peringkat_ver->result_array() as $p): ?>
                          ...
                          <td align="left"><?= "Rp. ".number_format($p['total_recoveries'],0,",",".") ?></td>
                       </tr> 
                      <?php endforeach ?>
                      </tbody>
                    </table>
