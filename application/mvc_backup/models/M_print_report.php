...
class M_print_report extends CI_Model {
	...
	{
		$this->db->select('cas.cabang_asuransi, cab.cabang_bank, ta.harga as total_harga, ta.keterangan, s.status_asset, ja.jenis_asset, j.jenis_dokumen as jenis_dok, d.nama_debitur, d.no_klaim');	
	...
	{
		$this->db->select('d.nama_debitur, d.no_klaim');	
		$this->db->from('dokumen_asset as ta');
		$this->db->join('m_jenis_asset as ja', 'ja.id_jenis_asset = ta.id_jenis_asset', 'left');
		$this->db->join('status_asset as s', 's.id_status_asset = ta.id_status_asset', 'left');
		$this->db->join('debitur as d', 'd.id_debitur = ta.id_debitur', 'left');
	...
	{
		$this->db->select('d.nama_debitur, d.no_klaim, ja.jenis_asset, jd.jenis_dokumen, da.harga, cas.cabang_asuransi, cab.cabang_bank, da.keterangan');
