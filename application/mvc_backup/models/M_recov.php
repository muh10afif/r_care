...
class M_recov extends CI_Model {
	...
	{
		$this->db->select('d.*, d.id_debitur,d.nama_debitur,d.bunga, b.bank, ca.cabang_asuransi, d.no_klaim, cab.cabang_bank, d.subrogasi, sum(r.nominal) as recoveries, ms.status_deb');
