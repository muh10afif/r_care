    ...
    <body>
      ...
      <table border="1" id="ad" width="100%">
        ...
        <tbody>
          ...
          <?php if (empty($nama_ver_jabar) && empty($nama_ver_jateng)): ?>

            <?php $a = (8+$s) ?>
            <tr>
              <td colspan="<?php echo $a ?>" align="center">DATA KOSONG</td>
            </tr>
          ...
          foreach ($nama_ver_jabar as $v): ?>
            ...
            <tr>
              ...
              <?php $j=0; for ($h = $awal; $h <= $akhir; $h++) : ?>
                ...
                <?php $noa = $this->M_all_report_syariah->get_data_jml_noa_2(1,$bln, $v['id_karyawan']); ?>
              ...
              <?php $noa_sudah = $this->M_all_report_syariah->get_data_jml_noa_sdh(1,$d_bulan_awal,$d_bulan_akhir,$v['id_karyawan']); ?>
              <td align="right"><?= $jl_noa ?></td>
              <td align="right"><?= number_format($jl_shs,0,'.','.') ?></td>

              <td align="right"><?= $v['jml_noa'] - $jl_noa ?></td>
              <td align="right"><?php $tt = $v['shs'] - $jl_shs; echo number_format($tt,0,'.','.'); ?></td>
          ...
          <tr id="d">
            ...
            <?php $k=0; for ($p = $awal; $p <= $akhir; $p++) : ?>
              ...
              <?php $j_noa = $this->M_all_report_syariah->get_data_jml_noa_s(1,$bln_2); ?>
              <?php 
            ...
            <?php $tot_noa_sdh = $this->M_all_report_syariah->get_data_tot_noa_sdh(1,$d_bulan_awal,$d_bulan_akhir); ?>
            <th style="text-align: right;"><?= $ttn = $jl_noa_a ?></th>
            <th style="text-align: right;"><?= number_format($jl_shs_a,0,'.','.') ?></th><?php $ttn_shs = $jl_shs_a; ?>

            <th style="text-align: right;"><?= $ttn_bl = $jml_noa_s - $jl_noa_a ?></th>
            <th style="text-align: right;"><?php $aa_bl = $jml_shs_s - $jl_shs_a; echo number_format($aa_bl,0,'.','.'); ?></th>
          </tr>
          ...
          foreach ($nama_ver_jateng as $v): ?>
            <tr>
              ...
              <?php $j=0; for ($h = $awal; $h <= $akhir; $h++) : ?>
                ...
                <?php $bln = tambah_bulan($d_bulan_awal, $j) ?>
                <?php $noa = $this->M_all_report_syariah->get_data_jml_noa_2(3,$bln, $v['id_karyawan']); ?>
                <td align="right"><?= $noa['jml_noa_jbr'] ?></td>
                <td align="right"><?= number_format($noa['shs_jbr'],0,'.','.') ?></td>
              ...
              <?php $noa_sudah = $this->M_all_report_syariah->get_data_jml_noa_sdh(3,$d_bulan_awal,$d_bulan_akhir,$v['id_karyawan']); ?>
              <td align="right"><?= $jl_noa ?></td>
              <td align="right"><?= number_format($jl_shs,0,'.','.') ?></td>
          ...
          <tr id="d">
            ...
            <?php $k=0; for ($p = $awal; $p <= $akhir; $p++) : ?>
              ...
              <?php $bln_2 = tambah_bulan($d_bulan_awal, $k) ?>
              <?php $j_noa = $this->M_all_report_syariah->get_data_jml_noa_s(3,$bln_2); ?>
              <?php 
            ...
            <?php $tot_noa_sdh = $this->M_all_report_syariah->get_data_tot_noa_sdh(3,$d_bulan_awal,$d_bulan_akhir); ?>
            <th style="text-align: right;"><?= $ttn_t = $jl_noa_a_x?></th>
            <th style="text-align: right;"><?= number_format($jl_shs_a_x,0,'.','.') ?></th><?php $ttn_shs_t = $jl_shs_a_x; ?>

            <th style="text-align: right;"><?= $ttn_bl_t = $jml_noa_x - $jl_noa_a_x ?></th>
            <th style="text-align: right;"><?php $aa_bl_t = $jml_shs_x - $jl_shs_a_x; echo number_format($aa_bl_t,0,'.','.'); ?></th>
          ...
          <tr id="d">
            ...
            <?php $noa_t = $this->M_all_report_syariah->get_data_jml_noa_tot($bln_t); ?>
            <?php 
