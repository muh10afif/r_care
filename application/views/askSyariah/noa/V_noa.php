		...
		<div class="col-md-9">
			...
			<div class="box-body table-responsive" style="background-color: white;">
				...
				<table class="table table-striped table-hover table-bordered" id="tabel">
					...
					<tbody>
						<?php $no=1; $tot=0; $tot_subro1=0; $tot_recov1=0; foreach ($data_r_noa as $noa): ?>
							<tr>
								...
								<td><?= (!empty($noa['status_deb']) ? $noa['status_deb'] : 'Tidak Ada') ?>
								<?php $tot += ($noa['subrogasi']-$noa['recoveries']) ?>
								<?php $tot_subro1 += $noa['subrogasi'];  ?>
								<?php $tot_recov1 += $noa['recoveries'];  ?>
								</td>
							</tr>
						<?php endforeach ?>
					</tbody>
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td align="center"><?= number_format($tot_subro1,2,',','.') ?></td>
                        </tr> 
                        <tr>
                          <td>Total Tagihan</td>
                          ...
                          <?php endforeach ?>
                          <td align="center"><?php $a = $tot_subro1+$bunga['total_bunga']+$tot_denda1; echo number_format($a,2,',','.'); ?></td>
                        </tr> 
                        <tr>
                          <td>Total Recoveries</td>
                          <td>:</td>
                          <td align="center"><?= $c = number_format($tot_recov1,2,',','.') ?></td>
                        </tr> 
                        <tr>
                          <td>Total SHS</td>
                          <td>:</td>
                          <td align="center"><?= number_format($tot_subro1 - $tot_recov1,2,',','.') ?></td>
                        </tr> 
                        <tr>
                          <td>Total Saldo Tagihan</td>
                          <td>:</td>
                          <td align="center"><?= number_format($a - $tot_recov1,2,',','.') ?></td>
                        </tr>
