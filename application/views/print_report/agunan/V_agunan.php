	...
	<div class="row">
		<div class="col-md-12">
			<div class="card border-info shadow">
				...
				<form method="POST" action="<?= base_url('r_print_report/agunan') ?>" autocomplete="off">
...
$(document).ready(function () {
	...
	$('#debitur').change(function () {
		...
		$.ajax({
			type		: "POST",
			url 		: "<?= base_url("r_print_report/list_no_klaim") ?>",
