...
<html>
    <head>
        <title>Laporan Keuangan 2</title>
    ...
    <body>
      ...
      <h6>BERDASARKAN CASH IN / PEMBAYARAN INVOICE TERTAGIH</h6>
      ...
      <table border="1" id="ad" width="100%">
        ...
        <?php endforeach ?>
            ...
            <tr>
                <th style="text-align: right">Jumlah Pendapatan (Cash Basis)</th>
                
                <?php $tot_inv=0; foreach ($bulan as $d): ?>

                    <?php $hasil = $this->M_laporan->get_pendapatan_invoice_dibayarkan($d)->row_array();
            ...
            <tr>
                ...
                <?php $tot_rl=0; foreach ($bulan as $d): ?>
                    ...
                    <?php $hasil2 = $this->M_laporan->get_pendapatan_invoice_dibayarkan($d)->row_array(); ?>
