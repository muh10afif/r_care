       ...
       <!--  <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        ...
        <div class="navbar-custom-menu " id="navbar-collapse" style="background-color:#EDE90F;">
          <ul class="nav navbar-nav">
            ...
            <li class="a <?= (!empty($report)) ? $report : '' ; ?>"><a href="<?= base_url() ?>askSyariah/r_semuaSyariah"><b style="color: #122E5D">All Report</b></a></li>
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="height: 50px">
                ...
                <span class="hidden-xs"><b style="color: #122E5D">Askrindo Syariah</b></span>
              </a>
