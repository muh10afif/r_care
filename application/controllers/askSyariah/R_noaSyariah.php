 ...
 * Katalog
 */
class R_noaSyariah extends CI_controller
{
	public function __construct()
	{
        ...
        $this->load->model(array('askSyariah/M_noa_syariah','askSyariah/M_ots_syariah'));
	}
    ...
    public function index()
    {
        if (isset($_POST['cari'])) {
            ...
            $data = [
                'noa'            => 'aktif',
                'judul'          => 'NOA',
                'potensial'      => $this->M_noa_syariah->get_status_debitur(),
                'bank'           => $this->M_noa_syariah->get_bank(),
                'data_r_noa'     => $this->M_noa_syariah->get_cari_data_r_noa($tgl_awal,$tgl_akhir,$potensial,$bank),
                'tot_noa'        => $this->M_noa_syariah->get_total('debitur', $tgl_awal,$tgl_akhir,$potensial,$bank),
                'sudah_ots'      => $this->M_noa_syariah->get_total('ots', $tgl_awal,$tgl_akhir,$potensial,$bank),
                'status_pot'     => $this->M_noa_syariah->get_status_pot('Potensial', $tgl_awal,$tgl_akhir,$potensial,$bank),
                'status_non_pot' => $this->M_noa_syariah->get_status_pot('Non Potensial', $tgl_awal,$tgl_akhir,$potensial,$bank),
                'tot_subrogasi'  => $this->M_noa_syariah->get_tot_subrogasi($tgl_awal,$tgl_akhir,$potensial,$bank),
                'denda'          => $this->M_noa_syariah->get_tot_denda($tgl_awal,$tgl_akhir,$potensial,$bank),
                'bunga'          => $this->M_noa_syariah->get_tot_bunga($tgl_awal,$tgl_akhir,$potensial,$bank),
                'tot_recov'      => $this->M_noa_syariah->get_tot_recov($tgl_awal,$tgl_akhir,$potensial,$bank),
                'p_tgl_awal'     => $tgl_awal,
            ...
            $this->template->load('template_syariah','askSyariah/noa/v_noa', $data);
            ...
            $data = [
                'judul'             => $all,
                'data_r_noa'        => $this->M_noa_syariah->get_cari_print_data_r_noa($tgl_awal,$tgl_akhir,$potensial,$bank),
                'data_noa_jml'      => $this->M_noa_syariah->get_data_noa_jml($tgl_awal,$tgl_akhir,$potensial,$bank), 
                'data_pot'          => $this->M_noa_syariah->get_data_pot('Potensial',$tgl_awal,$tgl_akhir,$potensial,$bank), 
                'data_non_pot'      => $this->M_noa_syariah->get_data_pot('Non Potensial',$tgl_awal,$tgl_akhir,$potensial,$bank), 
                'jml_data_pot'      => $this->M_noa_syariah->get_tot_pot('Potensial',$tgl_awal,$tgl_akhir,$potensial,$bank),
                'jml_data_non_pot'  => $this->M_noa_syariah->get_tot_pot('Non Potensial',$tgl_awal,$tgl_akhir,$potensial,$bank),
                'tgl_awal'          => $tgl_awal,
                'tgl_akhir'         => $tgl_akhir,
                'potensial'         => $potensial,
                'bank'              => $bank
            ...
            $this->load->view('askSyariah/noa/lihat_print', $data);
           ...
           $data = [
                ...
                'potensial'      => $this->M_noa_syariah->get_status_debitur(),
                'bank'           => $this->M_noa_syariah->get_bank(),
                'data_r_noa'     => $this->M_noa_syariah->get_data_r_noa(),
                'tot_noa'        => $this->M_ots_syariah->get_total('debitur'),
                'sudah_ots'      => $this->M_ots_syariah->get_total('ots'),
                'status_pot'     => $this->M_noa_syariah->get_status_pot('Potensial', $tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'status_non_pot' => $this->M_noa_syariah->get_status_pot('Non Potensial', $tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'tot_subrogasi'  => $this->M_noa_syariah->get_tot_subrogasi($tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'denda'          => $this->M_noa_syariah->get_tot_denda($tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'bunga'          => $this->M_noa_syariah->get_tot_bunga($tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'tot_recov'      => $this->M_noa_syariah->get_tot_recov($tgl_awal = null,$tgl_akhir = null,$potensial = null,$bank = null),
                'p_tgl_awal'     => '',
                'p_tgl_akhir'    => '',
                'p_potensial'    => '',
                'p_bank'         => ''
    ...
    public function unduh_pdf()
    {
        ...
        $this->load->view('askSyariah/noa/print', $data);   
    }
